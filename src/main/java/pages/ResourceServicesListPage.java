...
public class ResourceServicesListPage extends BasePage<ResourceServicesListPage>{
    ...
    @FindBy(css = "[data-testid='resource-location']")
    ...
    @FindBy(css = "[data-testid='resource-location-menu-list']")
    private WebElement locationsDropdownContainer;
    ...
    public ResourceServicesListPage(String browser, String version, String organizationId, String token) {
        super(browser, version, organizationId, token);
    }

    public ResourceServicesListPage(String browser, String version, String token) {
        super(browser, version, token);
    }

    public ResourceServicesListPage(String browser, String version) {
    ...
    public String getPageUrl() {
        return PAGE_URL + resourceToEnter.get().getString("id") + "/services";
    }
